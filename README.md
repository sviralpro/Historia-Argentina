...
<body>
    ...
    <script>
        const questions = [
            ...
            "¿COMO SE IlAMA EL GRUPO DE COMBATIENTES QUE ACOMPAÑÓ A GÜEMES? ¿POR QUÉ ESE NOMBRE? ",
            "¿QUÉ SIGNIFICA SER CAUDILLO?",
            "¿QUÉ VALORES /ENSEÑANZA NOS DEJA LA VIDA DE MARTIN GÜEMES?",
            ", ¿QUE SUCEDIO EL 17 DE JUNIO DE 1827? ",
            "¿QUIEN TRAiCIONO A GÜEMES? ¿POR QUE?",
            "¿QUÉ PROVINCIAS DEFENDiO.?",
            "¿CUAL FUE LA VESTIMENTIA QUE CARACTERIZABA A GÜEMES?  ¿A QUE CLASE SOCIAL PERTENECÍA?"
        ];
